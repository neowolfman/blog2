<nav class="bg-gray-800" x-data="{ open:false }">
    ...
    <div class="sm:hidden" x-show="open" x-on:click.away="open=false" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        @foreach ( $categorias as $categoria )
          <a href="{{route('posts.category', $categoria)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{ $categoria->name }}</a>
        @endforeach
